@if (Auth::user()->tipo_usuario_id != 1)
    <div class="row d-flex">
        <div class="col-md-3">
            <a href="{{ route('user.edit', Auth::user()->id) }}" type="submit" class="btn btn-primary"
                style="width: 300px;">Ir a Cambiar contraseña</a>
        </div>
    </div>
@else
    <div>
                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('reportes_pdf', $user->id) }}">
