                                            ...
                                            <form action="" id="formularioEventos" name="formularioEventos">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline mx-3 mt-1">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="estudiantes">Estudiantes</label>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <small id="helpId" class="form-text text-muted">Hora
                                                            Inicio</small>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        <div class="modal-body">
                                            <form action="" id="formularioEventos" name="formularioEventos">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="title">Tipo del Evento</label>
                                                        <select name="tipo_event_id" id="tipo_event_id"
                                                ...
                                                <div class="row" id="memo">
                                                    <div class="form-group">
                                                        <label for="memorandum">Cuerpo del Memorándum</label>
                                                        <textarea class="form-control" name="memorandum" id="memorandum" rows="2" disabled></textarea>
                                                        <small id="helpId" class="form-text text-muted">&nbsp;</small>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="descripcion">Descripción</label>
                                                    <textarea class="form-control" name="description" id="description" rows="1" disabled></textarea>
                                                    <small id="helpId" class="form-text text-muted">&nbsp;</small>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
